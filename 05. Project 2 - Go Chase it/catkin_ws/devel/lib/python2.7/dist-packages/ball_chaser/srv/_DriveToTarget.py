...
class DriveToTargetRequest(genpy.Message):
  _md5sum = "b986e56ca883c2d879b6deb49c975513"
  _type = "ball_chaser/DriveToTargetRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float64 angular_z
float64 linear_x
"""
  __slots__ = ['angular_z','linear_x']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2d().pack(_x.angular_z, _x.linear_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.angular_z, _x.linear_x,) = _get_struct_2d().unpack(str[start:end])
      return self
...
class DriveToTarget(object):
  ...
  _md5sum = 'e94c60c42161370f173f12a23d235942'
