...
get_filename_component(_filename "/home/robond/Desktop/catkin_ws/src/ball_chaser/srv/DriveToTarget.srv" NAME_WE)
add_custom_target(_ball_chaser_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ball_chaser" "/home/robond/Desktop/catkin_ws/src/ball_chaser/srv/DriveToTarget.srv" ""
)
...
_generate_srv_cpp(ball_chaser
  "/home/robond/Desktop/catkin_ws/src/ball_chaser/srv/DriveToTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ball_chaser)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ball_chaser\")")
  # install generated code
  install(
