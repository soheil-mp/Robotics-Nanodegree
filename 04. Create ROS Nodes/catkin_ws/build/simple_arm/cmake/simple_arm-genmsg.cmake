...
get_filename_component(_filename "/home/robond/Desktop/catkin_ws/src/simple_arm/srv/GoToPosition.srv" NAME_WE)
add_custom_target(_simple_arm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "simple_arm" "/home/robond/Desktop/catkin_ws/src/simple_arm/srv/GoToPosition.srv" ""
)
...
_generate_srv_cpp(simple_arm
  "/home/robond/Desktop/catkin_ws/src/simple_arm/srv/GoToPosition.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/simple_arm)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/simple_arm\")")
  # install generated code
  install(
